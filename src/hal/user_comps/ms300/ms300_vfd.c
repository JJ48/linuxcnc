/*
  ...
  Max Volanski, adapted from Yishin Li's vfdb_vfd.
  ...
  Copyright (C) 2013 Sebastian Kuzminsk
  Copyright (C) 2013 Max Volanski
...
#define REG_FREQUENCY                   0x2102  // Set frequency in 0.01Hz steps
#define REG_UPPERLIMIT                  0x211B  // limit on output frequency in VFD
...
static params_type param = {
        ...
        .last_errno = 0,
        .report_device = 0,
        .motor_hz = 60,     // 50 is common in Europe, 60 is common in the US
        .motor_rpm = 24000,  // 1410 is common in Europe, 1730 is common in the US
};
